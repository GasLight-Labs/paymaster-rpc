const abi = [
  {
    inputs: [
      { internalType: "contract IERC20Metadata", name: "_token", type: "address" },
      { internalType: "contract IEntryPoint", name: "_entryPoint", type: "address" },
      { internalType: "contract IOracle", name: "_tokenOracle", type: "address" },
      { internalType: "contract IOracle", name: "_nativeAssetOracle", type: "address" },
      { internalType: "uint32", name: "_stalenessThreshold", type: "uint32" },
      { internalType: "uint32", name: "_priceMarkupLimit", type: "uint32" },
      { internalType: "uint32", name: "_priceMarkup", type: "uint32" },
      { internalType: "uint256", name: "_refundPostOpCost", type: "uint256" },
    ],
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: "uint32", name: "priceMarkup", type: "uint32" }],
    name: "MarkupUpdated",
    type: "event",
  },
  {
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: "address", name: "_treasury", type: "address" }],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "bool", name: "paidByGuarantor", type: "bool" },
    ],
  ...
  {
    anonymous: false,
    inputs: [{ indexed: true, internalType: "address", name: "newVerifyingSigner", type: "address" }],
  ...
  {
    inputs: [{ internalType: "address", name: "_verifyingSigner", type: "address" }],
  ...
  {
    inputs: [{ internalType: "uint32", name: "_priceMarkup", type: "uint32" }],
    name: "updateMarkup",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
